...
- 0K-19 — Minimal Conversation Continuity: CLOSED
...
- 0K-21 — Frontend Chat UX Finalization: CLOSED.
...
- 0K-22 — Functional MVP Release Candidate & Final Validation: CLOSED. Ciclo de desarrollo Functional MVP 0K-16 → 0K-22 cerrado y validado; no es producción.
...
- 0K-24 — Voice Interaction Foundation: ACTIVE. Módulo actual 0K-24A.2 añade STT local `whisper.cpp` con modelo multilingüe `base`, español y WAV validado; no activa micrófono, TTS, reproducción de audio, WhatsApp ni servicios externos.
