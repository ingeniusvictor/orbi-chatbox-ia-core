...
const main = async (): Promise<void> => {
  ...
  const cases: QaCase[] = [
    ...
    { name: "valid widget message", path: "/api/public/widget/orbi_demo_widget_key/message", init: { method: "POST", headers: jsonHeaders, body: validMessage }, expected: { status: 200, assertions: hasFields({ ok: true, received: true, leadCreated: false }) } },
