...
const request: Readonly<AiProviderRequest> = Object.freeze({ requestId: "hardening-request", conversationId: "hardening-conversation", message: "sandbox assistant", knowledgeContext: context });
